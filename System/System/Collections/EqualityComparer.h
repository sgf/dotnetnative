...
namespace System::Collections
{
	...
	class GenericEqualityComparer<uint16_t>
		: public virtual EqualityComparer<uint16_t>
	{
	public:
		GenericEqualityComparer() = default;
		...
		virtual bool Equals(const uint16_t& x, const uint16_t& y) const noexcept override { return x == y; }
		virtual int GetHashCode(const uint16_t& obj) const override { return static_cast<int>(HashTrivialObject32<uint16_t>(obj)); }
	};
