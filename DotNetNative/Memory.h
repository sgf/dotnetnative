...
#define DNN_Alloc(size) Memory::Alloc(size)
#define DNN_CAlloc(num, size) Memory::CAlloc(num, size)
#define DNN_Realloc(memory, size) Memory::Realloc(memory, size)
#define DNN_Free(memory) Memory::Free(memory)

#define DNN_AlignedAlloc(size, alignment) Memory::AlignedAlloc(size, alignment)
#define DNN_AlignedCAlloc(num, size) Memory::AlignedCAlloc(num, size, alignment)
#define DNN_AlignedRealloc(memory, size) Memory::AlignedRealloc(memory, size, alignment)
#define DNN_AlignedFree(memory) Memory::AlignedFree(memory)

#else

#define DNN_Alloc(size) Memory::DebugAlloc(size, __FILE__, __LINE__)
#define DNN_CAlloc(num, size) Memory::DebugCAlloc(num, size, __FILE__, __LINE__)
#define DNN_Realloc(memory, size) Memory::DebugRealloc(memory, size, __FILE__, __LINE__)
#define DNN_Free(memory) Memory::DebugFree(memory, __FILE__, __LINE__)

#define DNN_AlignedAlloc(size, alignment) Memory::DebugAlignedAlloc(size, alignment, __FILE__, __LINE__)
#define DNN_AlignedCAlloc(num, size) Memory::DebugAlignedCAlloc(num, size, alignment, __FILE__, __LINE__)
#define DNN_AlignedRealloc(memory, size) Memory::DebugAlignedRealloc(memory, size, alignment, __FILE__, __LINE__)
#define DNN_AlignedFree(memory) Memory::DebugAlignedFree(memory, __FILE__, __LINE__)
