...
namespace System
{
	...
	{
	public:
		static constexpr uint16_t HIGH_SURROGATE_START = 0xd800;
		static constexpr uint16_t HIGH_SURROGATE_END = 0xdbff;
		static constexpr uint16_t LOW_SURROGATE_START = 0xdc00;
		static constexpr uint16_t LOW_SURROGATE_END = 0xdfff;
	...
	public:
		static UnicodeCategory GetUnicodeCategory(const uint16_t ch);
		...
		static double GetNumericValue(const uint16_t ch);
