 ...
 */
extern void* GC_malloc_index(size_t idx); //? VC暂为找到支持的同等代码 __attribute__((__malloc__)); https://stackoverflow.com/questions/18485447/gcc-attribute-malloc
#pragma warning( /* ? VC暂为找到支持的同等代码 __attribute__((__malloc__));*/)
 ...
 */
extern void GC_free_nonnull(void* ptr); //? VC暂为找到支持的同等代码 __attribute__((__nonnull__(1))); //__assume __assume(0) (__assume(1))  https://stackoverflow.com/questions/38641514/when-do-i-use-attribute-nonnull-vs-not-nullt
#pragma warning( /* ? VC暂为找到支持的同等代码 __attribute__((__nonnull__(1)));*/)
//
 ...
 */
extern GC_NoInline void GC_collect(void);
